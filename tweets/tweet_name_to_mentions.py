...
spark = SparkSession.builder.appName("Tweet Mining: name to mentions").config("spark.executor.memory", "500").getOrCreate()
...
name_to_count_RDD.saveAsTextFile(output_filepath)